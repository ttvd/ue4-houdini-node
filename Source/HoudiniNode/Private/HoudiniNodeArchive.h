...
public:
    ...
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, const TArray<FString>& String);
    ...
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, const TArray<float>& Value);
    ...
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, const TArray<int32>& Value);
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, int64 Value);
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, const TArray<int64>& Value);
    ...
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, const TArray<uint32>& Value);
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, uint64 Value);
    virtual FHoudiniNodeArchive& operator<<(const FString& Key, const TArray<uint64>& Value);
    ...
    virtual FHoudiniNodeArchive& operator<<(UObject* Object);
